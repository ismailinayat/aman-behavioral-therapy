...
const ContactPageForm = ({ post }: any) => {
  ...
  return (
    <form className="contact-page-form" onSubmit={clientAction}>
      <div className="contact-page-form__group">
        <input
          type="text"
        ...
        />
        <label htmlFor="name" className="contact-page-form__label">
          Full Name
        </label>
      </div>
      ...
      <div className="contact-page-form__group">
        ...
        />
        <label htmlFor="email" className="contact-page-form__label">
          Email address
        </label>
      </div>
      ...
      <div className="form__group">
        ...
        />
        <label htmlFor="message" className="contact-page-form__label">
          Write your message
        </label>
      </div>
